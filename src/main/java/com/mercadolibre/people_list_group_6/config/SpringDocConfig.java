package com.mercadolibre.people_list_group_6.config;

import static com.mercadolibre.people_list_group_6.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.people_list_group_6.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("lfantinati")
                .email("luciano.fantinati@mercadolivre.com"));
